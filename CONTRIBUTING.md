...
the State of Colorado government! If you're unsure about anything, just
...
<!--- TODO: what is the process for suggesting changes to the Figma file?.-->

### Team Specific Guidelines

This design system is maintained by the Colorado Digital Service. It follows the State of Colorado [Branding Guidelines](https://dcs.colorado.gov/ids/state-branding) and [Digital Guidelines](https://dcs.colorado.gov/ids/digital-guidelines-and-design-system). Suggestions for changes to the Design System should also follow those guidelines.


### Building Dependencies

The Figma Kit requires Figma. If you'd like access to the file and do not have Figma, let us know and we can work with you to find a good solution.

### Building the Project

TODO: once we have a build this section will describe the steps.
...
5.  From your branch, make a pull request against `coloradodigitalservice/colorado-design-system/main`
6.  Work with repo maintainers to get your change reviewed
7.  Wait for your change to be pulled into `coloradodigitalservice/colorado-design-system/main`
...
colorado-design-system will see regular updates and new releases. This section describes the general guidelines around how and when a new release is cut.
...
colorado-design-system uses [Semantic Versioning](https://semver.org/). Each release is associated with a [`git tag`](github.com/coloradodigitalservice/colorado-design-system/tags) of the form `X.Y.Z`.
...
The following steps outline the process to prepare a Release Candidate of colorado-design-system. This process makes public the intention and contents of an upcoming release, while allowing work on the next release to continue as usual in `dev`.
...
The following steps describe how to make an approved [Release Candidate](#preparing-a-release-candidate) an official release of colorado-design-system:
...
Merge Requests should include changes to the CHANGELOG.md when appropriate.

Releases provide another time to review the CHANGELOG.md and make adjustments based on what happened.
...
[proj-releases-new]: https://github.com/coloradodigitalservice/colorado-design-system/releases/new

## Documentation

We also welcome improvements to the project documentation or to the existing
docs. Please file an [issue](https://github.com/coloradodigitalservice/colorado-design-system/issues).

## Policies

### Open Source Policy

If you have any questions, just [send us an email](oit_coloradodigitalservice@state.co.us).
